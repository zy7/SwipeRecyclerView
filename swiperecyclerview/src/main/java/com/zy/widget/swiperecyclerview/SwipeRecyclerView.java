...
public class SwipeRecyclerView extends RecyclerView {
    ...
    protected SwipeLayout mOldSwipedLayout;
    ...
    public void smoothOpenLeftMenu(int position) {
        smoothOpenMenu(position, LEFT_DIRECTION, SwipeLayout.DEFAULT_SCROLLER_DURATION);
    }
    ...
    public void smoothOpenRightMenu(int position) {
        smoothOpenMenu(position, RIGHT_DIRECTION, SwipeLayout.DEFAULT_SCROLLER_DURATION);
    }
...
//        /position += getHeaderItemCount();
    ...
    private View getSwipeMenuView(View itemView) {
        if (itemView instanceof SwipeLayout) return itemView;
        ...
        while (!unvisited.isEmpty()) {
            ...
            if (child instanceof SwipeLayout) return child;
